                                        ...
                                        <div class="flex gap-2">
                                            @if ($item->status === 'proses')
                                                    <div class="relative inline-block text-left">
                                                        <button type="button"
                                                            class="p-2 bg-green-600/20 hover:bg-green-600/40 text-green-400 hover:text-green-300 rounded-lg transition-colors"
                                                            onclick="document.getElementById('dropdown-{{ $item->id }}').classList.toggle('hidden')"
                                                            title="Ubah Status">
                                                        ...
                                                        <div id="dropdown-{{ $item->id }}" 
                                                            ...
                                                            <form action="{{ route('admin.surat-keluar.update-status', $item->no_surat) }}" method="POST">
                                                                @csrf
                                                                @method('PUT')
                                                                <input type="hidden" name="status" value="diterima">
                                                                <button type="submit" 
                                                                    class="block w-full text-left px-4 py-2 text-sm hover:bg-green-100 text-green-600">
                                                                    ✔ Diterima
                                                                </button>
                                                            </form>
                                                            <form action="{{ route('admin.surat-keluar.update-status', $item->no_surat) }}" method="POST">
